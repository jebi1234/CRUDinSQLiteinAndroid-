...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (res != null) {
            ...
            TotalAmount.setText("Total Amount: "+TOtalAmount.toString())
...
//            if (ITENCount>=2)
//            {
//                DecrementCount.visibility = View.VISIBLE
//            }
            ...
            if (res != null) {
                while (res.moveToNext()) {
                    ...
                    if(res.getString(1)=="toy")
                    {
                        ...
                        ItemCount2.setText((itemcountbb.toInt()+1).toString())
            ...
            if (res != null) {
                while (res.moveToNext()) {
                    ...
                    if(res.getString(1)=="toy")
                    {
                        ...
                        ItemCount2.setText((itemcountddd.toInt()-1).toString())
